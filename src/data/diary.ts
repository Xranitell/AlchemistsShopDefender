...
export const BESTIARY_ENTRIES: BestiaryEntry[] = [
  {
    ...
    ruTierNotes: {
      ...
      epic: 'Распад усилен: 3 малых слизня с увеличенным запасом Прочности.',
  ...
  },
  {
    ...
    ruFeatures: [
      'Высокий запас Прочности и значительная броня.',
  ...
  },
  {
    ...
    ruFeatures: [
      'Аура исцеления восстанавливает Прочность ближайшим врагам.',
  ...
  },
  {
    ...
    ruFeatures: [
      ...
      'После 80% Прочности уклоняется боковым рывком при получении урона.',
      'Высокий запас Прочности, броня и награда за победу.',
    ],
    killThresholds: BOSS_THRESHOLDS,
    ruTierNotes: {
      normal: 'Сочетает ускоряющие рывки вперёд и боковое уклонение после 80% Прочности.',
  ...
  },
  {
    ...
    ruFeatures: [
      'Переходит во 2-ю и 3-ю фазы на порогах 66% и 33% Прочности.',
    ...
    killThresholds: BOSS_THRESHOLDS,
    ruTierNotes: {
      normal: 'В 3-й фазе ускоряется в 1.5 раза; смерть призванных миньонов лечит босса на 3 Прочности.',
