...
export const BESTIARY_ENTRIES: BestiaryEntry[] = [
  ...
  },
  {
    ...
    ruFeatures: [
      ...
      'Бежит зигзагом — короткие рывки то влево, то вправо мешают чейн-стрелкам пристреляться.',
  ...
  },
  {
    ...
    ruFeatures: [
      'Двигается зигзагом — поочерёдные рывки в стороны мешают пристреляться.',
