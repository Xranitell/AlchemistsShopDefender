...
export const ELEMENT_ENTRIES: ElementEntry[] = [
  ...
  },
  {
    ...
    ruFeatures: [
      ...
      'Сочетается с поджогом — огонь сильнее бьёт по цели с ослабленной бронёй.',
  ...
  },
  {
    ...
    ruFeatures: [
      ...
      'Ртутное кольцо вокруг манекена замедляет ближайших врагов.',
...
export const STANCE_ENTRIES: StanceEntry[] = [
  ...
  },
  {
    ...
    ruFeatures: [
      ...
      'Каждый уровень добавляет ещё один слот по очереди: ближайший слева → ближайший справа → дальше слева → дальше справа.',
      'Фонарь тоже может быть отключён ЭМИ-эффектами — не оставляй его без прикрытия.',
    ],
  },
];
